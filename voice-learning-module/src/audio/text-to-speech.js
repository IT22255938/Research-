...
export class VoiceSynthesizer {
  constructor(options = {}) {
    ...
    this.characters = {
      'sophie': {
        ...
        description: 'A cheerful, encouraging voice perfect for positive feedback'
      },
      'buddy': {
        name: 'Buddy',
        voice: 'male',
        ...
        description: 'An upbeat, playful voice for fun learning moments'
      },
      'teacher': {
        name: 'Teacher',
        voice: 'female',
        ...
        description: 'A calm, professional voice for clear explanations'
      },
      'dragon': {
        name: 'Dragon',
        voice: 'male',
        age: 'fantasy',
        personality: 'adventurous, mysterious',
        description: 'An exciting, imaginative voice for adventure-themed content'
      },
      'fairy': {
        name: 'Fairy',
        voice: 'female',
        age: 'fantasy',
        personality: 'magical, whimsical',
        description: 'A delightful voice with magical energy'
      }
    };

    this.emotionalTones = {
      'neutral': { pitchMultiplier: 1.0, rateMultiplier: 1.0, description: 'Normal speech' },
      'encouraging': { pitchMultiplier: 1.1, rateMultiplier: 0.9, description: 'Supportive and warm' },
      'celebratory': { pitchMultiplier: 1.2, rateMultiplier: 1.1, description: 'Excited and triumphant' },
      'calm': { pitchMultiplier: 0.9, rateMultiplier: 0.8, description: 'Peaceful and reassuring' },
      'excited': { pitchMultiplier: 1.3, rateMultiplier: 1.2, description: 'Very energetic' },
      'gentle': { pitchMultiplier: 0.8, rateMultiplier: 0.7, description: 'Soft and tender' }
    };
  ...
  /**
   * Speak with character context and automatic emotion tone
   */
  async speakAsCharacter(text, character = 'sophie', context = 'feedback') {
    const emotionMap = {
      'question': 'calm',
      'feedback': 'neutral',
      'correct': 'celebratory',
    ...
    const emotion = emotionMap[context] || 'neutral';
